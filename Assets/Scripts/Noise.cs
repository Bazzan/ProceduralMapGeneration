...
{
    public static float[,] GenerateNoiseMap(int mapWidth, int mapHeight, int seed, float scale, int octaves, float persistancec, float lacunarity, Vector2 offset)
    {
